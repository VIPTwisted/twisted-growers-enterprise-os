...
export const CORE_BOTS = [
  ...
  { id: "brand", name: "Brand", role: "Marketing locker",
    open: "brand_locker", reportsTo: "topg",
    prompts: ["Open the brand locker", "What is in marketing?"],
    job: "Company logos, ads, packaging, photos, video, gifs, zips, docs. Any file. Not Metrc." },
