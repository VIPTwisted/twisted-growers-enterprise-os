...
import {
  useDefaultRange, DkRangeSearch, rangeSearch, grab, listOf, DkTag, DkErr, DkEmpty, DkKpiStrip, DkDrill, DrillRoot, DkHead,
...
export default function HarvestsRegister({ go, session, role, viewAs, reports }) {
  ...
  const rs = useMemo(() => rangeSearch(rows, {
    ...
    fields: ["harvest_name", "strain", "room", "harvest_id"],
  ...
  return (
    <DrillRoot label="Harvests">
      <div className="ccpage">
        ...
        <DkRangeSearch id="h-q" label="Search harvest name, strain, room or tag"
          q={q} onQ={setQ} result={rs} noun="harvests" rangeLabel="this range"
          source="v_harvest_forensic" err={d.h.err} />
