# Clone history — these SQL files came with vip-hr-hub. The LIVE functions are in Twisted Growers' project fxetuqjryttnypgepsru, schema hr, recorded in the OS baseline. Nothing here is applied by hand.
