...
const IMPORT_TEMPLATES = [
  {
    ...
    example:['EMP001','First','Last','name@example.com','(000)000-0000','2026-01-15','Associate','Hartford','Active','18.00'],
  },
  {
    ...
    example:['EMP001','2026-06-01','09:00:00','17:30:00','Hartford','30','true'],
  },
  {
    ...
    example:['TXN001','EMP001','2026-06-01','10:23:00','Hartford','49.99','Accessories','Credit Card'],
  },
  {
    ...
    example:['SKU001','Product Name','Category A','Hartford','45','10','12.00','24.99'],
  },
  {
    ...
    example:['CUST001','First','Last','name@example.com','(000)000-0000','06101','Hartford','0','true'],
  },
  {
