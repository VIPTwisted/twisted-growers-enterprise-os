...
function buildDoc({ locName, weekStart, retain, sections, diff }) {
  ...
  <style>
    *{box-sizing:border-box} body{font-family:Georgia,'Times New Roman',serif;color:#111;margin:0;padding:32px;font-size:12px}
    ...
    <div class="lh">
      <div><div class="co">{companyName()}</div><h1>Schedule Record — ${esc(locName)}</h1>
    ...
    <div class="foot">Generated by {companyName()} HR · This is a frozen, immutable record. Snapshots are retained until their retain_until date and cannot be altered after capture.</div>
  </body></html>`
}
