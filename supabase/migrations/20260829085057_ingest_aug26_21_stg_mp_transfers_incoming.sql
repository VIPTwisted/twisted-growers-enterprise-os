...
-- ── stg_mp_transfers_incoming: 2 rows ──────────────────────────────
create table if not exists public.stg_mp_transfers_incoming (
  manifest text,
...
alter table public.stg_mp_transfers_incoming enable row level security;
drop policy if exists stg_mp_transfers_incoming_read on public.stg_mp_transfers_incoming;
create policy stg_mp_transfers_incoming_read on public.stg_mp_transfers_incoming for select to authenticated using (true);
insert into public.stg_mp_transfers_incoming (manifest,source_file,file_sha256,licence,file_window) values
('0003384726','Metrc-Massachusetts-MP281909-LicensedTransfers-Incoming (1).xlsx','8c54894ee771d2a4e221e54825fd9bce5011038eda3c5b064fe5c2c9e07e423d','MP281909',null),
('0003384557','Metrc-Massachusetts-MP281909-LicensedTransfers-Incoming (1).xlsx','8c54894ee771d2a4e221e54825fd9bce5011038eda3c5b064fe5c2c9e07e423d','MP281909',null);
