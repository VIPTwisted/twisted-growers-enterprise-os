-- TG Enterprise OS — 0004 Metrc staging, Control Tower, Seeds (CODE-010/011 + Metrc read-first)
...
insert into cultivars (canonical_name, aliases) values
 ...
 ('XJ-13','{}'),('Orange Cream','{}'),('Pink Drink','{}'),
 ('Moraccan Peaches','{"Moraccan Paches","Moraccan Paches/Dirty Taxi"}'),
 ('Chimera','{}'),('LMNT 115','{LMNT}'),('Shake Shack','{}'),
 ('Satsuma Sherbet','{"Satsuma Sherbert"}'),
 ('Gastro Pop','{}'),('Warheads','{}'),('Fluffernutter','{}'),('PB&J','{}'),
 ('Zombie Apocalypse','{}'),('Modified Funk','{}'),('Afternoon Delight','{}'),
 ('Strawberry Cookies','{"Strawberry Cookie"}'),('Dr. Rendezvous','{}'),
 ('Senor Giggles','{"Señor Giggles"}'),('Lemoncello Spritz','{"Lemoncello Sprtiz"}');
