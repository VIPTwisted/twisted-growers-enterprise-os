-- BP-12g: the P&L is one row per book per month (MC281714 cultivation, MP281909 manufacturing); the strip took one row
-- with limit 1 and read $0 revenue for a month that had $131,809 on the other book. The company figure is the sum of
-- the books.
